(() => {
 ...
 window.showLetterGift=(number,eligible)=>{
  ...
  const progress=document.createElement('progress');progress.className='gift-progress';progress.max=tapsNeeded;progress.value=0;progress.setAttribute('aria-label','Gift unwrapping progress');
